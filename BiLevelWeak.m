function [RFinal,ULevelWise,VLevelWise,hmf_Lvl_trn_err,hmf_Lvl_tst_err,hmf_fnl_trn_err,hmf_fnl_tst_err] ...
    = BiLevelWeak(Rtrn, Rtst, par)
...
%for i= priorityOrder(1:ratingLevel-1)
        ...
        [y, U, V]=factorizeWeak(RcapTrn, level, par);
        ULevelWise(:,:,i) = U;
        VLevelWise(:,:,i) = V;
        %y
        %full(RcapTrn)
